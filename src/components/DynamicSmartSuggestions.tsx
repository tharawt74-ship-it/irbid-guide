...
export function DynamicSmartSuggestions({ onSelectSuggestion }: DynamicSmartSuggestionsProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 mb-2.5 px-2 max-w-xl mx-auto">
        <div className="flex items-center gap-1.5 text-xs text-white/80 font-bold">
          ...
          <AnimatePresence mode="wait">
            <motion.span
              ...
              className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-black border backdrop-blur-sm ${currentGroup.badgeBg}`}
            >
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-white/10 hover:bg-white/20 text-white/90 hover:text-white text-[11px] font-bold transition-all cursor-pointer"
          >
            <motion.div
      ...
      <div className="relative min-h-[50px] flex items-center justify-center overflow-hidden">
        <AnimatePresence mode="wait">
          <motion.div
            key={currentGroup.id}
          ...
          >
            {currentGroup.suggestions.map((sug, idx) => (
              <motion.button
                ...
                className={`group relative overflow-hidden px-3.5 py-1.5 rounded-full font-bold text-xs transition-all shadow-sm cursor-pointer backdrop-blur-md border ${
                  sug.highlight
