...
export function Layout() {
  ...
  const navItems = [
    ...
    { path: '/offers', label: 'عروض وخصومات', icon: Flame, isSpecial: true, badge: '% خصومات' },
    ...
    <div className="min-h-screen bg-[#fdfcfb] flex flex-col font-sans text-[#2d2a26] overflow-x-clip" dir="rtl">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-2.5 xl:gap-3.5 flex-nowrap shrink-0 min-w-0">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[8px] md:text-[9px] font-bold text-stone-400 mt-0.5 hidden sm:block whitespace-nowrap">دليل عروس الشمال</span>
              </div>
            </Link>
            ...
            <nav className="flex items-center gap-1 xl:gap-1.5 text-xs xl:text-[13px] font-bold flex-nowrap shrink-0">
              ...
              >
                ...
                <span className={cn(
                  "text-[9px] font-black px-1.5 py-0.5 rounded-full whitespace-nowrap hidden xl:inline-block",
                  location.pathname === '/offers' 
                    ? "bg-white/25 text-white" 
                    : "bg-gradient-to-r from-red-600 to-orange-500 text-white shadow-xs animate-pulse"
                )}>
                  % خصومات
                </span>
              </Link>
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center pointer-events-auto">
            ...
            >
              ...
              <div className="flex flex-col text-right">
                ...
                <span className="text-[8px] font-bold text-stone-400 mt-0.5 whitespace-nowrap">دليل عروس الشمال</span>
              </div>
            </Link>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50">
          {/* Backdrop */}
          <div 
            className="fixed inset-0 bg-stone-950/70 backdrop-blur-sm transition-opacity animate-in fade-in duration-200"
            onClick={closeMenu}
          />
          ...
          <div 
            ...
            className="fixed inset-y-0 right-0 w-full max-w-[320px] bg-stone-50 shadow-2xl flex flex-col h-full max-h-screen z-50 animate-in slide-in-from-right duration-300 relative" 
            dir="rtl"
          >
              ...
              <div className="space-y-2 pt-1">
                ...
                <nav className="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <span className="text-[9px] bg-white/20 text-white font-black px-1.5 py-0.5 rounded">
                      خصومات
                    </span>
                  </Link>
      ...
      <footer className="bg-white border-t border-[#e5e1da] mt-auto">
        <div className="max-w-[1200px] mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              <Link to="/" className="text-2xl font-black tracking-tighter text-[#1a4d2e] flex items-center gap-2 mb-4">
                ...
                <span>شو في بإربد؟<span className="text-[#ff9f1c]">.</span></span>
              </Link>
              <p className="text-stone-500 text-sm leading-relaxed max-w-sm mb-4">
                المنصة الأولى لاكتشاف أفضل المطاعم والمقاهي والمحلات التجارية في عروس الشمال. دليلك الشامل لكل ما تحتاجه في إربد.
              </p>
              <button
                type="button"
                onClick={triggerPwaInstallModal}
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-stone-500 mb-4">
                ...
                <li className="flex items-center gap-2" dir="ltr"><Mail className="h-4 w-4 text-[#ff9f1c]" /> info@irbidguide.com</li>
                <li className="flex items-center gap-2" dir="ltr"><Phone className="h-4 w-4 text-[#ff9f1c]" /> +962 7 0000 0000</li>
              </ul>
              ...
              <div className="flex items-center gap-2 pt-1">
                ...
                <a
                  ...
                  title="تلغرام"
                  aria-label="تلغرام"
                  className="w-8 h-8 rounded-xl bg-sky-50 text-sky-600 border border-sky-200 flex items-center justify-center hover:scale-110 hover:bg-sky-100 transition-all shadow-3xs"
                >
          ...
          <div className="pt-8 border-t border-[#e5e1da] text-center text-sm font-medium text-stone-400 flex flex-col md:flex-row justify-between items-center gap-4">
            <div>© {new Date().getFullYear()} شو في بإربد؟. جميع الحقوق محفوظة.</div>
            <div className="flex gap-4">
              <span className="hover:text-[#1a4d2e] cursor-pointer transition-colors">الشروط والأحكام</span>
              <span className="hover:text-[#1a4d2e] cursor-pointer transition-colors">سياسة الخصوصية</span>
            </div>
          </div>
        </div>
      </footer>
