...
const DEFAULT_VIP_PLANS: VipPlanConfig[] = [
  ...
  },
  {
    ...
    features: [
      'إعلان بانر متحرك أعلى الصفحة الرئيسية (تبدأ من 25 د.أ)',
      'صدارة نتائج البحث للمحل Sponsored (تبدأ من 15 د.أ)',
      'إشعار ترويجي فوري موجه لجميع مستخدمي المنصة (تبدأ من 10 د.أ)'
    ]
  }
];
