                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="flex items-center gap-1.5">
                                ...
                                {vipInfo.isVip && (
                                  <span className={`text-[10px] font-black px-1.5 py-0.2 rounded flex items-center gap-0.5 shadow-2xs ${
                                    vipInfo.isTrial
                                      ? 'bg-amber-100 text-amber-900 border border-amber-300'
                                      : 'bg-gradient-to-r from-amber-500 to-amber-600 text-white'
                                  }`}>
                                    <Crown className={`h-2.5 w-2.5 ${vipInfo.isTrial ? 'text-amber-600' : 'fill-white'}`} />
                                    {vipInfo.isTrial ? `تجربة VIP (${vipInfo.daysRemaining ?? 14}d)` : 'VIP'}
                                  </span>
                                )}
                              </div>
                ...
                >
                  <div className="space-y-3 flex-1">
                    <div className="flex flex-wrap items-center gap-2.5">
                      ...
                      {req.status === 'approved' && (
                        <span className="bg-[#e2f0d9] text-[#385723] px-3 py-1 rounded-full text-xs font-black flex items-center gap-1">
                          <CheckCircle2 className="h-3 w-3 text-[#385723]" />
                          مقبول وموثق
                        </span>
                      )}
                      {req.status === 'rejected' && (
