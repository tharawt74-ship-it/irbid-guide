...
import { Business, JobOffer } from '../types';
...
export function Profile() {
  ...
  const [activeSectionTab, setActiveSectionTab] = useState<'overview' | 'edit_info' | 'offers' | 'jobs' | 'marketing' | 'reviews'>('overview');
  ...
  const handleMarketingRequest = async (serviceType: string, serviceName: string, successMessage: string) => {
    if (!currentUser || !selectedBusinessIdForService) return;
    ...
    try {
      ...
      setServiceRequestSuccess(successMessage);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="border border-[#e5e1da] rounded-2xl p-5 hover:border-[#ff9f1c]/30 transition-all flex flex-col group relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                <button 
                  onClick={() => handleMarketingRequest('sponsored', 'صدارة البحث (Sponsored)', 'تم استلام طلبك لخدمة "صدارة البحث". سيتواصل معك فريقنا قريباً لإتمام الدفع وتفعيل الخدمة.')}
            ...
            <div className="border border-[#e5e1da] rounded-2xl p-5 hover:border-[#1a4d2e]/30 transition-all flex flex-col group relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                <button 
                  onClick={() => handleMarketingRequest('push_notifications', 'إشعارات جماعية', 'تم استلام طلبك لخدمة "إشعارات جماعية". سيتواصل معك فريقنا قريباً.')}
            ...
            <div className="border border-[#e5e1da] rounded-2xl p-5 hover:border-purple-300 transition-all flex flex-col group relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                <button 
                  onClick={() => handleMarketingRequest('homepage_banner', 'بانر إعلاني مميز', 'تم استلام طلبك لخدمة "بانر إعلاني مميز". سيتواصل معك فريقنا قريباً.')}
            ...
            <div className="border border-[#e5e1da] rounded-2xl p-5 hover:border-stone-400 transition-all flex flex-col group relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                <button 
                  onClick={() => handleMarketingRequest('nfc_stands', 'ستاندات وبطاقات NFC', 'تم استلام طلبك لخدمة "ستاندات NFC". سيتواصل معك فريقنا قريباً.')}
            ...
            <div className="border border-[#e5e1da] rounded-2xl p-5 hover:border-pink-300 transition-all flex flex-col group relative overflow-hidden lg:col-span-2">
              ...
              <div className="flex items-center justify-between mt-auto pt-2 border-t border-stone-100">
                ...
                <button 
                  onClick={() => handleMarketingRequest('social_media', 'تغطية سوشيال ميديا شاملة', 'تم استلام طلبك لخدمة "تغطية سوشيال ميديا". سيتواصل معك فريقنا لتحديد موعد التصوير.')}
